...
| **Lab 7: Threat-Model the Agent & Design Security Controls** | Score SupportFlow against a real documented attack chain from MITRE ATLAS. **Browser only, no Colab** | [Control inventory](docs/supportflow_control_inventory.md) · [Starter layer](atlas/supportflow_starter_layer.json) |
...
atlas/
  supportflow_starter_layer.json   ATLAS Navigator starter layer for Lab 7: the
                                   AML.CS0039 attack chain pointed at SupportFlow.
                                   Three steps pre-answered, five to score

docs/
  supportflow_control_inventory.md  generated by tools_build_inventory.py. What a
                                    reviewer gets instead of a shell
```
